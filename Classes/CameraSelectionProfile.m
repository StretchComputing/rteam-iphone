...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    @try {
        ...
        if ((count - 2) >= 0) {
            ...
            if ([Player class] == [views[[views count] - 2] class]) {
                Player *tmpController = (Player *)views[[views count] - 2];
            ...
            }else if ([Fan class] == [views[[views count] - 2] class]) {
                Fan *tmpController = (Fan *)views[[views count] - 2];
        ...
        if ((count - 3) >= 0) {
            ...
            if ([Player class] == [views[[views count] - 3] class]) {
                
                Player *tmpController = (Player *)views[[views count] - 3];
            ...
            }else if ([Fan class] == [views[[views count] - 3] class]) {
                Fan *tmpController = (Fan *)views[[views count] - 3];
