...
@interface NewFootballScoring : UIViewController {
	...
	IBOutlet UIButton *addThem6;
	IBOutlet UIButton *addUs1;
	IBOutlet UIButton *addUs3;
	IBOutlet UIButton *addUs6;
	...
	IBOutlet UIButton *hideGameScoringButton;
...
@property (nonatomic, retain) UIButton *hideGameScoringButton;
...
@property (nonatomic, retain) UIButton *addThem6;
@property (nonatomic, retain) UIButton *addUs1;
@property (nonatomic, retain) UIButton *addUs3;
@property (nonatomic, retain) UIButton *addUs6;
