...
@implementation PracticeMessages
@synthesize results, teamName, teamId, practiceId, inboxResults, outboxResults, noInbox, noOutbox, error, userRole, 
...
-(void)getAllMessages{
	...
	if (![token isEqualToString:@""]){
		...
		response = [ServerAPI getMessageThreads:token :self.teamId :@"all" :self.practiceId :@"practice" :@"both" :@"active"];
...
-(void)sendMessage{
	...
	nextController.eventId = self.practiceId;
	nextController.eventType = @"practice";
	nextController.origLoc = @"PracticeTabs";
